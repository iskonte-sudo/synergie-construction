      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 relative">
            ...
            <img
              src={aboutImage}
              alt="Synergies Construction Group"
              loading="lazy"
            ...
            <div className="absolute -bottom-8 -right-8 bg-[#FFB800] p-6 hidden md:block shadow-xl">
              <div className="font-heading text-5xl font-extrabold text-[#0A2540] leading-none">
                {company.projects}+
              </div>

              <div className="text-xs uppercase tracking-widest text-[#0A2540] font-semibold mt-2">
                Projets réalisés
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-6">
            ...
            <p className="text-gray-600 mt-6 leading-relaxed">
              <strong className="text-[#0A2540]">
                Synergies Construction Group (SCG)
              </strong>{' '}
              est une entreprise spécialisée dans les études, la conception et
              la réalisation de projets de construction. Nous accompagnons
              particuliers, entreprises et institutions à chaque étape de leurs
              projets, de l'idée initiale jusqu'à la livraison finale.
            </p>
        ...
        <div className="relative max-w-[1400px] mx-auto px-4 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 text-white pt-6">
            ...
            <p className="text-white/80 mt-5 leading-relaxed max-w-xl">
              Synergies Construction Group vous offre un accompagnement complet
              tout au long de votre projet. De l'élaboration des plans 2D et 3D
              jusqu'à la livraison finale, nous mettons à votre disposition une
            ...
            <div className="mt-10 space-y-3">
              {steps.map((s, i) => (
                <div
                  key={i}
                  className="group flex items-center gap-5 border-b border-white/15 pb-3 hover:border-[#FFB800]"
                >
                  <span className="font-heading text-3xl font-extrabold text-[#FFB800] w-14 shrink-0">
                    {s.step}
                  </span>

                  <div>
                    <div className="font-heading font-bold uppercase text-lg">
                      {s.title}
                    </div>
